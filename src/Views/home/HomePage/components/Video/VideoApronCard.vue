<!-- src/Views/home/HomePage/components/Video/VideoApronCard.vue -->
<template>
  <div>
    <div
    class="playback-icon-apron"
    :style="bgStyle"
    ...
    <teleport to="body">
      <div
        v-show="visible"
        class="video-wrapper-apron"
        ref="videoWrapperRef"
        :style="wrapperStyle"
        @mousedown="onMouseDown"
      >
      <button class="close-button-apron" @click="closeVideo">×</button>

      <div class="video-container-apron">
