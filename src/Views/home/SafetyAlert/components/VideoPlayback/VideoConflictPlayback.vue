...
<template>
  ...
  import defaultSrc from '@/assets/icons/icons_FlightConflict/videoreplay.webp'
  import hoverSrc from '@/assets/icons/icons_FlightConflict/videoreplay.webp'
  ...
  const initialPosition = { top: window.innerHeight * 0.56, left: window.innerWidth * 0.23 }
