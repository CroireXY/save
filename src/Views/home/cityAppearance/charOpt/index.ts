...
//  tooltip: {
//     trigger: 'item', // 鼠标悬浮在数据点或区域才会显示
//     formatter: function(params:any) {
//       // params.name 是系列名
//       // params.value 是 value 数组
//       // 你可以自定义格式
//       let res = params.name ? params.name + '<br/>' : '';
//       params.value.forEach((val:any, idx:any) => {
//         res += `${val}<br/>`;
//       });
//       return res;
//     }
...
export const option7 = () => {
  ...
  return {
    ...
    tooltip: {
      // 格式化提示内容
      formatter: function (params: any) {
        return params.name + " : " + params.value + "mm";
      },
    },
    xAxis: [
      {
