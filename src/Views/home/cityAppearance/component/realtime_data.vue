...
.box {
  ...
  .item {
    ...
    // &:hover {
    //   box-shadow: 0 0 12px rgba(100, 100, 255, 0.8),
    //     0 0 24px rgba(100, 100, 255, 0.6), 0 0 48px rgba(100, 100, 255, 0.4);
    // }
